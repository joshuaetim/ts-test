...
function getConnection() {
    ...
    let connection = new sequelize_1.Sequelize(process.env.DEV_DATABASE_NAME, process.env.DEV_DATABASE_USER, process.env.DEV_DATABASE_PASSWORD, {
        dialect: 'mysql',
        host: '127.0.0.1',
        port: 3306,
        pool: {
...
exports.sequelize = getConnection();
